...
These were implemented as one part of my master's thesis within the LASEC (Cryptography and Security lab) at EPFL, "Gotta Study 'Em All: An efficiency and security analysis of the POKÉ family of PKEs from higher-dimensional isogenies". This project was co-supervised by Dr. Andrea Basso at IBM Research Zürich and Prof. Péter Kutas at Eötvös Loránd University (ELTE).
...
#### Comparison of our implementations to prior C implementations

|                    | POKÉ (ms) | INKE (ms) |
|--------------------|-----------|-----------|
| Keygen (level I)   | 71.181    | 63.450    |
| Keygen (level III) | 288.57    | 216.88    |
| Keygen (level V)   | 705.21    | 570.59    |
| Enc (level I)      | 8.8790    | 10.152    |
| Enc (level III)    | 32.415    | 30.793    |
| Enc (level V)      | 71.928    | 73.465    |
| Dec (level I)      | 11.889    | 5.0418    |
| Dec (level III)    | 43.272    | 15.204    |
| Dec (level V)      | 94.475    | 35.880    |

...
use poke::{
    ...
    poke::PublicParams,
    rand::{sample_random_torsion_basis_order_product_of_powers_of_small_primes, sample_random_unit_mod_prime_power},
};
...
>(
    ...
    let (U, V, eUV) = sample_random_torsion_basis_order_product_of_powers_of_small_primes(

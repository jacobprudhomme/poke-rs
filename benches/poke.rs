...
fn poke(c: &mut Criterion) {
    ...
    let params_iii = params::poke_iii::get_params();
    ...
    keygen_group.bench_function("POKÉ level I", |b| b.iter(|| keygen(&params_i)));
    keygen_group.bench_function("POKÉ level III", |b| b.iter(|| keygen(&params_iii)));
    keygen_group.bench_function("POKÉ level V", |b| b.iter(|| keygen(&params_v)));
    keygen_group.finish();
    ...
    encryption_group.bench_function("POKÉ level III", |b| {
    ...
    decryption_group.bench_function("POKÉ level III", |b| {

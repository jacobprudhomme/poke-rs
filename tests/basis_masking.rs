...
#[case::poke_level_iii(poke_iii::get_params())]
#[case::poke_level_v(poke_v::get_params())]
fn all_methods_for_different_scalars_are_equal<Fp2: Fp2Trait>(#[case] params: PublicParams<Fp2>) {
...
#[case::poke_level_iii(poke_iii::get_params())]
#[case::poke_level_v(poke_v::get_params())]
fn all_methods_for_scalar_matrix_are_equal<Fp2: Fp2Trait>(#[case] params: PublicParams<Fp2>) {
...
#[case::poke_level_iii(poke_iii::get_params())]
#[case::poke_level_v(poke_v::get_params())]
fn all_methods_for_special_case_are_equal<Fp2: Fp2Trait>(#[case] params: PublicParams<Fp2>) {
    let S = sample_random_invertible_matrix_mod_prime_power(5, &params.five_torsion_order);
    let (P, Q, _) = sample_random_torsion_basis_order_prime_power(
        &params.starting_curve,
        5,
